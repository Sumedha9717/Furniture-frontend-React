...
const Header = () => {
  ...
  return(
   <header className={`${bg ?'bg-blue-600 py-4 lg:py-6' : 'bg-none'} fixed left-0 w-full py-8 z-10 transition-all duration-200`}>
    <div className='container mx-auto'>
      <div className='flex justify-between items-center'>
        ...
        {/* menu icon */}
        <div onClick={()=> setMobileNav(!mobileNav)} className='text-2x1 text-white md:hidden lg:text-3x1 cursor-pointer'>
